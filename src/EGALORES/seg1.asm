; ======================================================================
; EGALORES / seg1.asm   (segment 1 of EGALORES)
; ----------------------------------------------------------------------
; Functions discovered (pass1b):        45
; Total instructions:                 4375
; 
...
; Prologue: none     Epilogue: jmp_tail
;
; Near calls (internal): L_0EC6, L_2426, L_24B2, L_282C
;-------------------------------------------------------------------------
;   [sub-routine] L_0541
L_0541:
...
; Prologue: none     Epilogue: jmp_tail
;
; Near calls (internal): L_0536, L_1C1F, L_1CEE, L_2327, L_2426, L_24B2, L_282C
;-------------------------------------------------------------------------
;   [sub-routine] L_0EC6
L_0EC6:
        ; constant WM_SETTEXT
...
;
; Near calls (internal): L_2036, L_225F, L_2322, L_27EE
;-------------------------------------------------------------------------
;   [sub-routine] L_20B4
L_20B4:
        push    si                              ; 56
...
L_2770:
        ...
        jmp     L_277F                          ; EB 01
;-------------------------------------------------------------------------
; sub_277E   offset=0x277E  size=54 instr  segment=seg1.asm
;
; Classification (pass8): unclear  (score C=1, ASM=2)
...
L_2792:
        ...
        add     ax, word ptr [bx]               ; 03 07
;-------------------------------------------------------------------------
; sub_27EE   offset=0x27EE  size=28 instr  segment=seg1.asm
;
; Classification (pass8): asm_medium  (score C=0, ASM=4)
; Prologue: none     Epilogue: ret
;-------------------------------------------------------------------------
...
L_27EE:
        ...
        shl     si, 1                           ; D1 E6
        or      si, 2                           ; 81 CE 02 00
;   [conditional branch target (if/else)] L_2810
L_2810:
        dec     dl                              ; FE CA
        jl      L_2828                          ; 7C 14
;   [loop start] L_2814
L_2814:
        ...
        dec     dl                              ; FE CA
        jge     L_2814                          ; 7D EC
;   [error/early exit] L_2828
L_2828:
        add     di, 8                           ; 83 C7 08
        ret                                     ; C3
;-------------------------------------------------------------------------
; sub_282C   offset=0x282C  size=18 instr  segment=seg1.asm
;
; Classification (pass8): asm_medium  (score C=0, ASM=4)
; Prologue: none     Epilogue: jmp_tail
;-------------------------------------------------------------------------
...
L_2845:
        ...
        clc                                     ; F8
        jmp     bx                              ; FF E3
;   [conditional branch target (if/else)] L_284A
L_284A:
